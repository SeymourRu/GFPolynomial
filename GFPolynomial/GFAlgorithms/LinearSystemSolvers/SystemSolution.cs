...
namespace GFAlgorithms.LinearSystemSolver
{
    ...
    public class SystemSolution
    {
        ...
        /// Variables values
        /// </summary>
        public FieldElement[] VariablesValues { get; private set; }
        ...
        private SystemSolution(int solutionsCount, FieldElement[] variablesValues)
        {
            if ((variablesValues == null || variablesValues.Length == 0) && solutionsCount != 0)
                throw new ArgumentException("variablesValues");
        ...
        public bool IsInfinite
        {
            get
            {
                return _solutionsCount == int.MaxValue;
            }
        }
