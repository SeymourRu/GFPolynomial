...
namespace GFAlgorithms.BiVariablePolynomials
{
    ...
    public class BiVariablePolynomial : IEnumerable<KeyValuePair<Tuple<int, int>, FieldElement>>
    {
        ...
        public bool IsZero
        {
            get
            {
                return _coefficients.Count == 0;
            }
        }
        /// <summary>
        /// Maximum degree of the current bivariate polynomial by x variable
        /// </summary>
        public int MaxXDegree 
        {
            get
            {
                return IsZero ? 0 : _coefficients.Keys.Max(x => x.Item1);
            }
        }
        /// <summary>
        /// Maximum degree of the current bivariate polynomial by y variable
        /// </summary>
        public int MaxYDegree
        {
            get
            {
                return IsZero ? 0 : _coefficients.Keys.Max(x => x.Item2);
            }
        }
        /// <summary>
