...
namespace GFPolynoms.GaloisFields
{
    public abstract class GaloisField
    {
        ...
        protected void ValidateArguments(int a, int b)
        {
            ...
            {
                throw new ArgumentException(string.Format("Element {0} is not field member",b));
            }
        }
        ...
        public int Pow(int element, int degree)
        {
            ...
            {
                throw new ArgumentException(string.Format("Element {0} is not field member", element));
            }
