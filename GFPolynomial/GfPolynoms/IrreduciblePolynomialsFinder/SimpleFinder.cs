...
namespace IrreduciblePolynomialsFinder
{
    ...
    public class SimpleFinder : IIrreduciblePolynomialsFinder
    {
        ...
        private static bool Generate(GFPolynoms.Polynomial templatePolynomial, int position, Func<GFPolynoms.Polynomial, bool> onCompleteAction)
        {
        ...
        private static GFPolynoms.Polynomial GenerateTemplatePolynomial(GaloisField field, int degree)
        {
