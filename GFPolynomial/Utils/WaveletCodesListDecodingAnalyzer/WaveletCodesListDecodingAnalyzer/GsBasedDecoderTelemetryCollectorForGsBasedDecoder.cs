namespace WaveletCodesListDecodingAnalyzer
{
    ...
    public class GsBasedDecoderTelemetryCollectorForGsBasedDecoder : IGsBasedDecoderTelemetryCollector
    {
        ...
        /// </summary>
        public int ProcessedSamplesCount
        {
            get
            {
                return _processedSamplesCount;
            }
        }
        /// <summary>
        /// Распределения длин списков в результатах декодирования
        /// </summary>
        public ConcurrentDictionary<Tuple<int, int>, int> ProcessingResults { get; private set; }
        /// <summary>
        /// Отобранные интересные примеры
        /// </summary>
        public ConcurrentDictionary<Tuple<int, int>, List<Tuple<FieldElement, FieldElement>[]>> InterestingSamples { get; private set; }
